...
float CalcShadow(vec3 position_of_models_fragments, vec3 normal_arg, vec3 direction_of_light_arg)
{
	...
	vec3 light_pos_to_fragment_pos = position_of_models_fragments - pos_of_light;
	...
	float closest_depth_from_light = texture(depth_map_texture, light_pos_to_fragment_pos.xyz).r;
...
void main()
{
	...
	shadows = CalcShadow(position_of_models_fragments, normalized_normal_coordinates, direction_of_light_from_model);
